export default {
  ...
  banner: {
    ...
    minutes: 'phút',
    second: 'giây',
    placehold: 'Địa chỉ email của bạn',
  },
  about: {
    title: 'Về chúng tôi',
    descript:
    ...
    user: 'Người chơi',
    games: 'Trò chơi',
    infoTitle1: 'Truy Cập 24/7',
    infoTitle2: 'Thiết Kế',
    infoTitle3: 'Đội Ngũ',
    infoDescript1: `Đảm bảo hoạt động kinh doanh của các nhà khai thác hoạt động trơn tru suốt cả năm. `,
    infoDescript2: `Kết hợp các vũ trụ giàu trí tưởng tượng, động lực chơi và lối chơi chưa từng có, trò chơi của chúng tôi vượt qua ranh giới của thế giới ảo bằng cách tạo ra lối chơi sáng tạo. `,
    infoDescript3: `Etech là một studio quốc tế, từng đoạt giải thưởng gồm các nhà thiết kế, nghệ sĩ, họa sĩ hoạt hình và nhà sản xuất chuyên tạo ra nội dung cho những tên tuổi lớn nhất trong lĩnh vực điện ảnh và trò chơi điện tử.`,
  },
  ourGame: {
    title: 'Trò chơi',
    descript:
  ...
  contact: {
    address: 'Địa chỉ',
    subscribe: 'Theo dõi',
    branch1: 'Valletta Buildings, South Street, Valletta - VLT 1103 Malta, Mỹ',
    branch2:
